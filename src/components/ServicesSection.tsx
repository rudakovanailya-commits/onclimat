...
const services = [
  { icon: Wrench, title: "Установка кондиционеров под ключ", text: "Аккуратный монтаж с гарантией и запуском" },
  { icon: RefreshCw, title: "Обслуживание кондиционеров", text: "Чистка, проверка и поддержание эффективной работы" },
  { icon: Search, title: "Диагностика и ремонт", text: "Выезд мастера и точное определение неисправности" },
  { icon: PenTool, title: "Проектирование по вашему ТЗ", text: "Разрабатываем решения для квартир, домов и коммерческих помещений", extra: "Подбор и расчёт оборудования" },
];
